...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li id="item_1" style="visibility:hidden"><a href="searchDevice.do?userId=<%=rb.getUserId()%>&page=1&roleName=<%=rb.getRoleName()%>" target="right"><span class="icon-caret-right"></span>设备管理</a></li>
    <li id="item_2" style="visibility:hidden"><a href="searchClient.do?userId=<%=rb.getUserId()%>&page=1&roleName=<%=rb.getRoleName()%>" target="right"><span class="icon-caret-right"></span>终端用户管理</a></li>
