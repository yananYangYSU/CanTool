...
public class CurrentDataAction {
	...
	public String addClientBefore(HttpServletRequest request,HttpSession session,Model model){
		try{
			...
			if(rb!=null){
				...
				return GetHttpType.isMobileDevice(request)?"pages/operator/addClient":"MobilePages/operator/addClient";
			}else{
	...
	public String updateClientBefore(HttpServletRequest request,HttpSession session,Model model,
		...
		try{
			...
			return GetHttpType.isMobileDevice(request)?"pages/operator/updateClient":"MobilePages/operator/updateClient";
		}catch(Exception e){
	...
	public String searchClient(HttpServletRequest request,Model model,
		...
		try{
			...
			return GetHttpType.isMobileDevice(request)?"pages/operator/searchClient":"MobilePages/operator/searchClient";
		}catch(Exception e){
			logger.error("login error"+e);
			e.printStackTrace();
			return "pages/error";
	...
	public String viewClient(HttpServletRequest request,Model model,
		...
		try{
			...
			return GetHttpType.isMobileDevice(request)?"pages/operator/viewClient":"MobilePages/operator/viewClient";
		}catch(Exception e){
			logger.error("searchClientById error"+e);
			e.printStackTrace();
			return "pages/error";
